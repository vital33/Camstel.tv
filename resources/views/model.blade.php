...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="search-bar">
            <form class="search-form d-flex align-items-center" method="POST" action="#">
                <input type="text" name="query" placeholder="Search models..." title="Enter search keyword">
                <button type="submit" title="Search models..."><i class="bi bi-search"></i></button>
            </form>
        </div><!-- End Search Bar -->

        <nav class="header-nav">
            <ul class="d-flex align-items-center">
                <li class="mav-item"><a href="#" class="nav-link nav-icon"><button type="button"
                            class="btn btn-warning">Join Free</button></a></li>
                <li class="mav-item"><a href="#" class="nav-link nav-icon"><button type="button"
                            class="btn btn-outline-secondary">Login</button></a></li>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed text-uppercase" data-bs-target="#icons-nav" data-bs-toggle="collapse"
                    href="#">
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">{{ $model->nick }}</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
